...
CREATE TABLE IF NOT EXISTS partidos (
  ...
  fase TEXT NOT NULL DEFAULT 'grupos' CHECK (fase IN ('grupos', 'dieciseisavos', 'octavos', 'cuartos', 'semifinales', 'tercero', 'final')),
  ganador_equipo TEXT,
  penales_local INTEGER,
  penales_visitante INTEGER,
  avanza_local_real BOOLEAN,
